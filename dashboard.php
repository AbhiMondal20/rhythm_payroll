    ...
    <div id="appShell" style="display:block;">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav style="flex:1;overflow-y:auto;padding:4px 0">
                ...
                <a class="nav-item" data-page="holidays" onclick="nav('holidays')">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <rect x="3" y="4" width="18" height="18" rx="2" />
                    <line x1="16" y1="2" x2="16" y2="6" />
                    <line x1="8" y1="2" x2="8" y2="6" />
                    <line x1="3" y1="10" x2="21" y2="10" />
                    <polygon points="12,13 13,16 16,16 13.5,18 14.5,21 12,19 9.5,21 10.5,18 8,16 11,16" />
                </svg>
                    Holiday
                </a>
                ...
                <a class="nav-item" data-page="config" onclick="nav('config')">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <path
                            d="M19.07 4.93l-1.41 1.41M5.34 17.66l-1.41 1.41M2 12h2M20 12h2M5.34 6.34L3.93 4.93M18.66 17.66l1.41 1.41M12 20v2M12 2v2" />
                    </svg>
                    Configuration
                </a>
            </nav>
            <div style="padding:12px;border-top:1px solid rgba(255,255,255,.05)">
                <div style="display:flex;align-items:center;gap:9px;padding:8px">
                    <div class="av" style="background:var(--y);color:var(--navy);width:34px;height:34px;font-size:12px">
                        AD</div>
                    <div style="flex:1;min-width:0">
                        <div style="color:#fff;font-size:13px;font-weight:600">Admin</div>
                        <div
                            style="color:#5C6080;font-size:11px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
                            ramkrishnaivf.in</div>
                    </div>
                    <button onclick="doLogout()" style="background:none;border:none;cursor:pointer;color:#5C6080"
                        title="Logout">
                ...
                <div
                    style="background:rgba(255,224,0,.08);border:1px solid rgba(255,224,0,.15);border-radius:8px;padding:8px 10px;margin-top:6px">
                    ...
                    <div class="pb" style="margin-top:5px">
                        <div class="pf" style="width:92%;background:var(--y)"></div>
                    </div>
                </div>
            </div>
        </aside>
            ...
            <header class="topbar">
                <div style="display:flex;align-items:center;gap:12px">
                    <button onclick="toggleSidebar()"
                        style="background:none;border:1px solid var(--border);border-radius:8px;padding:6px 8px;cursor:pointer;color:var(--muted)">
                ...
                <div style="display:flex;align-items:center;gap:8px">
                    <button onclick="openModal('addEmployeeModal')"
                        style="display:flex;align-items:center;gap:6px;background:var(--card);border:1px solid var(--border);border-radius:8px;padding:7px 13px;cursor:pointer;font-size:13px;font-weight:500;color:var(--text)">
                    ...
                    <button onclick="runPayroll()"
                        style="background:var(--y);border:none;border-radius:8px;padding:7px 13px;cursor:pointer;font-size:13px;font-weight:600;color:var(--navy)">Run
                        Payroll</button>
                    <button
                        style="position:relative;background:none;border:1px solid var(--border);border-radius:8px;padding:6px 8px;cursor:pointer;color:var(--muted)">
                    ...
                    <div
                        style="display:flex;align-items:center;gap:8px;padding:5px 10px;border:1px solid var(--border);border-radius:8px;cursor:pointer">
                        <div class="av"
                            style="background:var(--y);color:var(--navy);width:26px;height:26px;font-size:11px">AD</div>
    ...
    <div class="modal-bg" id="addEmployeeModal" style="display:none" onclick="closeModalBg(event,'addEmployeeModal')">
        <div class="modal">
            <div class="modal-header">
                ...
                <button onclick="closeModal('addEmployeeModal')"
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group"><label>EMAIL</label><input type="email" placeholder="name@example.com">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group"><label>DESIGNATION</label><input type="text" placeholder="e.g. Sr. Nurse">
                    </div>
                </div>
                <div class="form-row">
    ...
    <div class="modal-bg" id="runPayrollModal" style="display:none" onclick="closeModalBg(event,'runPayrollModal')">
        <div class="modal">
            <div class="modal-header">
                ...
                <button onclick="closeModal('runPayrollModal')"
                    style="background:none;border:none;cursor:pointer;color:var(--muted);font-size:20px">×</button>
            </div>
            <div class="modal-body">
                <div style="background:#F9FAFB;border-radius:10px;padding:16px;margin-bottom:16px">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                        <div>
                            <div style="font-size:11px;color:var(--muted);font-weight:600">TOTAL EMPLOYEES</div>
                            <div style="font-size:20px;font-weight:700;margin-top:2px">65</div>
                        </div>
                        <div>
                            <div style="font-size:11px;color:var(--muted);font-weight:600">GROSS PAYROLL</div>
                            <div style="font-size:20px;font-weight:700;margin-top:2px">₹8,42,500</div>
                        </div>
                        <div>
                            <div style="font-size:11px;color:var(--muted);font-weight:600">PF EMPLOYER</div>
                            <div style="font-size:20px;font-weight:700;margin-top:2px;color:var(--purple)">₹1,01,100
                            </div>
                        </div>
                        <div>
                            <div style="font-size:11px;color:var(--muted);font-weight:600">NET PAYABLE</div>
                            <div style="font-size:20px;font-weight:700;margin-top:2px;color:var(--green)">₹7,23,400
                            </div>
                        </div>
                    </div>
                </div>
                <p style="font-size:13px;color:var(--muted)">This will process payroll for all 65 active employees for
                    April 2026. Salary slips will be generated and emailed automatically.</p>
            </div>
            <div class="modal-footer">
