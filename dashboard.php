  ...
  <div class="stat-card" style="<?= $s['border'] ?>">
    <div style="display:flex;align-items:flex-start;justify-content:space-between">
      <div>
        ...
        <p style="font-size:26px;font-weight:700;color:#1a1a2e;line-height:1.1;margin-top:4px"><?= $s['value'] ?></p>
        <p style="font-size:12px;color:<?= $s['sub_color'] ?>;margin-top:4px;font-weight:500"><?= $s['sub'] ?></p>
      </div>
      <div style="background:<?= $s['icon_bg'] ?>;border-radius:10px;padding:10px">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="<?= $s['icon_color'] ?>" stroke-width="2">
...
<div class="grid-3" style="margin-bottom:16px">
  <div class="section-card" style="grid-column:span 2">
    <div style="padding:16px 20px;border-bottom:1px solid #F3F4F6;display:flex;align-items:center;justify-content:space-between">
      ...
      <div style="display:flex;gap:20px">
        <div><span style="font-size:11px;color:#6B7280;font-weight:600">PF TOTAL</span><div style="font-size:16px;font-weight:700;color:#7C3AED"><?= fmt_inr($total_pf) ?></div></div>
        <div><span style="font-size:11px;color:#6B7280;font-weight:600">ESI TOTAL</span><div style="font-size:16px;font-weight:700;color:#2563EB"><?= fmt_inr($total_esi) ?></div></div>
      </div>
    </div>
  ...
  <div class="section-card">
    ...
    <div style="padding:12px 16px">
      ...
      <?php endforeach; ?>
      <a href="leave.php" class="btn" style="width:100%;justify-content:center;margin-top:4px;border-style:dashed;color:#7C3AED">View All Holidays →</a>
    </div>
  </div>
</div>
...
<div class="grid-3" style="margin-bottom:16px">
      ...
      <tr>
        <td>
          <div style="display:flex;align-items:center;gap:10px">
            <div class="avatar" style="background:#EDE9FE;color:#7C3AED;font-size:11px"><?= $ini ?></div>
  ...
  <div style="display:flex;flex-direction:column;gap:16px">
    <!-- Dept Headcount -->
    <div class="section-card">
      <div style="padding:14px 16px;border-bottom:1px solid #F3F4F6"><h2 style="font-size:14px;font-weight:700">Dept. Headcount</h2></div>
      <div style="padding:12px 16px">
      ...
      <div style="padding:12px 16px;display:flex;flex-direction:column;gap:8px">
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:10px;background:#FFF7ED;border-radius:8px;border-left:3px solid #EA580C">
          ...
          <div style="flex:1">
            ...
            <div style="font-size:11px;color:#6B7280"><?= htmlspecialchars($a['employee']) ?> · <?= $a['detail'] ?></div>
          </div>
          <a href="approvals.php" style="font-size:11px;background:#D1FAE5;color:#065F46;border:none;border-radius:5px;padding:3px 8px;cursor:pointer;font-weight:600;text-decoration:none">Review</a>
        </div>
        <?php endforeach; ?>
      </div>
    </div>
